...
#region PARTICLES
        ...
        private class RegisterRenderResourcesBridgeParams
        {
            ...
            public UnityTextureBridge SDFRender;
        }
        ...
        private class RenderParams
        {
            ...
            public Int32 RenderParamsPadding;

            public Int32 MaxVertexBufferSize;
            public Int32 MaxIndexBufferSize;
            public Vector2Int RenderParamsPadding2;
        }
...
#region SOLVER
        ...
        public bool IsRenderingEnabled()
        {
            ...
            return initialized && runRendering && (simulationInternalFrame > 1) &&
                   (CurrentRenderingMode != RenderingMode.UnityRender);
        }
        ...
        private void InitializeParticles()
        {
            ...
            if (manipulatorManager != null)
            {
                ...
                GCHandle gcparamBuffer1 = default(GCHandle);
                ...
                gcparamBuffer0.Free();
                gcparamBuffer2.Free();
                if (gcparamBuffer1 != default(GCHandle))
                {
                    gcparamBuffer1.Free();
                }

                if (embeddingDataHandle != default(GCHandle))
                {
                    embeddingDataHandle.Free();
                }
                if (sdfGridHandle != default(GCHandle))
                {
                    sdfGridHandle.Free();
                }

                toFreeOnExit.Add(nativeRegisterManipulatorsBridgeParams);
            }
            else
            {
        ...
        public bool SetMaterialParams(Camera cam)
        {
            ...
            CurrentMaterial.SetFloat("RayMarchResolutionDownscale", renderingParameters.RayMarchingResolutionDownscale);
                                        ...
                                        RenderTargetIdentifier? sourceDepthTexture = null, Rect? viewport = null)
        {
            ...
            {
                cmdBuffer.SetGlobalTexture("ShadedLiquid", color2);
            }
            else
            {
                                ...
                                Rect? viewport = null)
        {
            ...
            if (EnableDownscale)
            {
                cmdBuffer.SetRenderTarget(color2);
